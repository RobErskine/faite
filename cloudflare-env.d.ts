/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 603e5a05268632ec07f3688baa148cdc)
// Runtime types generated with workerd@1.20260730.1 2026-08-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ATTACHMENTS: R2Bucket;
	DESKTOP_ASSETS: R2Bucket;
	AUTH_DB: D1Database;
	EMAIL: SendEmail;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_INGEST_DOMAIN" | "OWNER_EMAILS" | "NEXTJS_ENV" | "BETTER_AUTH_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_PLACES_API_KEY" | "TURNSTILE_SECRET_KEY" | "ATTACHMENTS_ORIGIN">> {}
}
